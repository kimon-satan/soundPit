...
void interface::setup(){
	...
	for(int i = 0; i < 4; i++){
		...
		temp.isFilled = false;
		temp.col = 0;
		temp.rect.width = 3; temp.rect.height = 3;
	...
	transRects[0].rect.x = 12.5; transRects[0].rect.y = 12.5;
	transRects[1].rect.x = 37.5; transRects[1].rect.y = 12.5; 
	transRects[2].rect.x = 12.5; transRects[2].rect.y = 37.5; 
	transRects[3].rect.x = 37.5; transRects[3].rect.y = 37.5; 
