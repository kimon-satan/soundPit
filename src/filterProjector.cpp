...
void filterProjector::drawMenus(myCvmask *masker){
    ...
    glTranslatef(0,15,0);
    if(selectedMenu == 2){ofSetColor(0x00ffff);}else{ofSetColor(0xffffff);}
